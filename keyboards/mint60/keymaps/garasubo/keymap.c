...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT( \
    ...
    KC_LSFT,       KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,      KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_LANG5,   KC_UP,  MO(1),   \
  ...
  [1] = LAYOUT( \
    ...
    XXXXXXX,   _______,    _______,    _______,    XXXXXXX,       XXXXXXX, KC_LANG1, KC_LANG2,                   KC_HOME, KC_PGDN, KC_END \
  )
};
